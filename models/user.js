...
const User = {
  findUserById: async (id) => {
    ...
    signup: async (user) => {
      const { id, password, name, address, phone, sliderValue_a, sliderValue_b, sliderValue_c, diseaseList, allergyList} = user;
      ...
      await db.query(query, [id, password, name, address, phone, sliderValue_a, sliderValue_b, sliderValue_c, disease, allergy]);
    },
